...
interface SurveyCreationLayoutProps {
  children: React.ReactNode
}

export default function SurveyCreationLayout({
  children,
}: SurveyCreationLayoutProps) {
  return (
      ...
      <div className="container flex-1 items-start md:grid md:grid-cols-[220px_minmax(0,1fr)] md:gap-6 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-10">
        <aside className="fixed top-20 z-30 -ml-2 hidden h-[calc(100vh-5rem)] w-full shrink-0 justify-between overflow-y-auto border-r md:sticky md:flex md:flex-col">
          <ScrollArea className="py-6 pr-6 lg:py-8">
            <h3 className="text-lg font-normal">Survey Creation</h3>
